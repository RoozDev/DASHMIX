...
-->
<div id="page-container" class="sidebar-o sidebar-dark sidebar-r enable-page-overlay side-scroll page-header-fixed main-content-narrow rtl-support">
    <!-- Side Overlay-->
    <aside id="side-overlay">
        <!-- Side Header -->
        <div class="bg-image" style="background-image: asset('backend/media/various/bg_side_overlay_header.jpg');">
                            ...
                            <div class="block-content">
                                <ul class="nav-items">
                                    ...
                                    <li>
                                        <a class="media py-2" href="be_pages_generic_profile.html">
                                            <div class="mx-3 overlay-container">
                                                <img class="img-avatar img-avatar48" src="{{ asset('backend/media/avatars/avatar14.jpg') }}" alt="">
                                                <span class="overlay-item item item-tiny item-circle border border-2x border-white bg-success"></span>
                                            </div>
                                            <div class="media-body">
                            ...
                            <div class="block-content">
                                <ul class="nav-items">
                                    <li>
                                        <a class="media py-2" href="be_pages_generic_profile.html">
                                            <div class="mx-3 overlay-container">
                                                <img class="img-avatar img-avatar48" src="{{ asset('backend/media/avatars/avatar9.jpg') }}" alt="">
                            ...
                            <div class="block-content">
                                <ul class="nav-items">
                                    <li>
                                        <a class="media py-2" href="be_pages_generic_profile.html">
                                            <div class="mx-3 overlay-container">
                                                <img class="img-avatar img-avatar48" src="{{ asset('backend/media/avatars/avatar15.jpg') }}" alt="">
                                    ...
                                    <li>
                                        <a class="media py-2" href="be_pages_generic_profile.html">
                                            <div class="mx-3 overlay-container">
                                                <img class="img-avatar img-avatar48" src="{{ asset('backend/media/avatars/avatar4.jpg') }}" alt="">
                                                <span class="overlay-item item item-tiny item-circle border border-2x border-white bg-muted"></span>
                                            </div>
                                            <div class="media-body">
                                    ...
                                    <li>
                                        <a class="media py-2" href="be_pages_generic_profile.html">
                                            <div class="mx-3 overlay-container">
                                                <img class="img-avatar img-avatar48" src="{{ asset('backend/media/avatars/avatar5.jpg') }}" alt="">
                                                <span class="overlay-item item item-tiny item-circle border border-2x border-white bg-muted"></span>
                                            </div>
                                            <div class="media-body">
                                    ...
                                    <li>
                                        <a class="media py-2" href="be_pages_generic_profile.html">
                                            <div class="mx-3 overlay-container">
                                                <img class="img-avatar img-avatar48" src="{{ asset('backend/media/avatars/avatar13.jpg') }} " alt="">
                                                <span class="overlay-item item item-tiny item-circle border border-2x border-white bg-muted"></span>
                                            </div>
                                            <div class="media-body">
    ...
    -->
    <nav id="sidebar" aria-label="Main Navigation rtl-support">
        <!-- Side Header -->
    ...
    <!-- Header -->
    <header id="page-header rtl-support">
        <!-- Header Content -->
        <div class="content-header">
            <!-- Left Section -->
            <div>
...
<script src="{{ asset('backend/js/dashmix.core.min.js') }}"></script>
